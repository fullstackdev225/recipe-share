...
<head>
    ...
    <title>RecipeShare - Ajouter vos recettes</title>
         ...
         <nav class="navbar navbar-expand-md bg-dark">
            <div class="container">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a href="create_recipe.php" class="nav-link nav-link--active text-light">Ajouter recette</a></li>
                ...
                <form method="POST" class="form">
                    <div class="form-section">
                        <div class="col-7">
                            ...
                            <input type="text" name="title" id="title" required placeholder="Donnez le nom de la recette" class="form-control">
                        </div>
                    </div><br>
                    ...
                    <div class="form-section">
                        <div class="col-7">
                            ...
                            <textarea name="description" id="description" required placeholder="Décrivez la recette (ingrédients, temps de cuisson etc.)" cols="30" rows="10" class="form-control"></textarea>
                        </div>
                    </div><br>
                    ...
                    <div class="form-section">
                        <div class="col-7">
                            ...
                            <input type="text" name="author" id="author" required placeholder="Qui a créer la recette?" class="form-control">
                        </div>
                    </div><br>
                    ...
                    <div class="form-section">
                        <div class="col-7">
                            ...
                            <input type="url" name="image" id="image" required placeholder="http://..." class="form-control">
                        </div>
                    </div><br>
